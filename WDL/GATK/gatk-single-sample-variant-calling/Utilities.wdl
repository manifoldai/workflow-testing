...
task CreateSequenceGroupingTSV {
  ...
  runtime {
    ...
    docker: "public.ecr.aws/docker/library/python:3.9-slim"
    memory: "2 GiB"
  }
  output {
...
task ScatterIntervalList {
  input {
    ...
    String docker = "broadinstitute/genomes-in-the-cloud:2.3.1-1512499786"
  }
...
task GetValidationInputs {
  input {
    ...
    String docker = "public.ecr.aws/docker/library/python:3.9-slim"
    Int cpu = 1
    Int memory_mb = 2000
    Int disk_size_gb = 20
  }
